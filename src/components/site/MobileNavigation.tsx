...
const shopCategoryItems: SiteMenuItem[] = [
  { label: "Flower", href: "/menu/flower" },
  { label: "Popcorn Bud", href: "/menu/popcorn-bud" },
  { label: "Infused Flower", href: "/menu/infused-flower" },
  { label: "Preroll", href: "/menu/preroll" },
  { label: "Blunt", href: "/menu/blunt" },
  { label: "Preroll Pack", href: "/menu/preroll-pack" },
  { label: "Infused Preroll", href: "/menu/infused-preroll" },
  { label: "Infused Blunt", href: "/menu/infused-blunt" },
  { label: "Infused Preroll Pack", href: "/menu/infused-preroll-pack" },
  { label: "Cartridge", href: "/menu/cartridge" },
  { label: "Disposable Cartridge", href: "/menu/disposable-cartridge" },
  { label: "Concentrate", href: "/menu/concentrate" },
  { label: "RSO", href: "/menu/rso" },
  { label: "Edible (Solid)", href: "/menu/edible-solid" },
  { label: "Edible (Liquid)", href: "/menu/edible-liquid" },
  { label: "Tincture", href: "/menu/tincture" },
  { label: "Topical", href: "/menu/topical" },
  { label: "Accessories", href: "/menu/accessories" },
  { label: "Greenway Merch", href: "/menu/merch" },
];
