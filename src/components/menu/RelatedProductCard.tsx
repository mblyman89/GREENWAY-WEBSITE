 ...
 * the struck price. menuCardDiscountForItem applies that policy.
 *
 * SLICE 96 (owner directive): the deal BADGE now comes from the shared
 * menuCardBadgeForItem engine — the same one every ProductCard uses — so the
 * rail matches the shop/home/specials cards exactly (badge every day the item
 * is deal-relevant, incl. Fri/Sat/Sun where the struck price stays hidden).
 */
