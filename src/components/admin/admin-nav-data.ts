...
export const adminNav: AdminNavItem[] = [
  ...
  { label: "Loyalty signups", href: "/admin/loyalty-signups", permission: "loyalty.view", icon: "\u2605", group: "Dashboard" },
  ...
  { label: "Other Inventory", href: "/admin/inventory/noncannabis", permission: "inventory.manage", icon: "\ud83e\uddf4", group: "Inventory" },
  { label: "Vendors & Brands", href: "/admin/vendors", permission: "vendors.manage", icon: "\ud83c\udff7", group: "Inventory" },
  { label: "Types & Categories", href: "/admin/settings/types", permission: "settings.manage", icon: "\ud83c\udff7", group: "Inventory" },
  ...
  { label: "AI Usage", href: "/admin/ai-usage", permission: "reports.view", icon: "\u2728", group: "Admin" },
  ...
  { label: "Menu Imports", href: "/admin/menu-imports", permission: "menu.import", icon: "\u2b06", group: "Admin" },
];
