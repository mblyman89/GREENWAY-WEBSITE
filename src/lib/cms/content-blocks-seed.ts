...
export const CONTENT_BLOCK_SEEDS: ContentBlockSeed[] = [
  ...
  // seeding produces no visible change until a block is edited + published.
  {
  ...
  {
    block_key: "pricematch.hero.eyebrow",
    page: "price-match",
    section: "hero",
    label: "Price Match — small eyebrow",
    help_text: "The small gold uppercase label above the promise headline (currently “Guaranteed savings”).",
    field_type: "plain",
    defaultValue: "Guaranteed savings",
  },
  {
  ...
  {
    block_key: "pricematch.hero.intro",
    page: "price-match",
    section: "hero",
    label: "Price Match — intro paragraph",
    help_text: "The paragraph under the promise headline that explains the price match promise.",
    field_type: "rich",
    defaultValue:
  ...
  {
    block_key: "pricematch.hero.image",
    page: "price-match",
    section: "hero",
    label: "Price Match — graphic / photo",
    help_text:
      "The graphic shown inside the Price Match card. Leave empty to keep the built-in placeholder artwork; pick or generate an image to replace it.",
    field_type: "image",
    seo_impact: false,
    defaultValue: "",
  },
  {
    block_key: "pricematch.details.heading",
    page: "price-match",
    section: "details",
    label: "Price Match — details heading",
    help_text: "The small heading above the list of price match rules (currently “Details:”).",
    field_type: "plain",
    defaultValue: "Details:",
  },
  {
    block_key: "pricematch.details.item1",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 1",
    help_text: "The first price match rule.",
    field_type: "plain",
    defaultValue: "Must be a loyalty member. Ask your budtender for more info!",
  },
  {
    block_key: "pricematch.details.item2",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 2",
    help_text: "The second price match rule.",
    field_type: "rich",
    defaultValue:
  ...
  {
    block_key: "pricematch.details.item3",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 3",
    help_text: "The third price match rule.",
    field_type: "plain",
    defaultValue: "We will match prices of other PORT ORCHARD, Washington state marijuana retailers, only.",
  },
  {
    block_key: "pricematch.details.item4",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 4",
    help_text: "The fourth price match rule.",
    field_type: "plain",
    defaultValue: "Item must be identical to the items being price matched (vendor/brand and size).",
  },
  {
    block_key: "pricematch.details.item5",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 5",
    help_text: "The fifth price match rule.",
    field_type: "plain",
    defaultValue: "Prices must include ALL TAXES (Washington state marijuana tax and local sales tax).",
  },
  {
    block_key: "pricematch.details.item6",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 6",
    help_text: "The sixth price match rule.",
    field_type: "plain",
    defaultValue: "Price must be available via competitor website, menu, or by calling the store.",
  },
  {
    block_key: "pricematch.details.item7",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 7",
    help_text: "The seventh price match rule.",
    field_type: "plain",
    defaultValue: "Price match items can not be discounted further.",
  },
  {
    block_key: "pricematch.details.item8",
    page: "price-match",
    section: "details",
    label: "Price Match — detail 8",
    help_text: "The eighth price match rule.",
    field_type: "plain",
    defaultValue: "All sales must remain compliant.",
  },
  {
