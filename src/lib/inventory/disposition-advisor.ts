...
const SYSTEM = [
  ...
  "- Destruction: current WAC 314-55-097 — waste is rendered unusable ON premises by grinding and mixing to at least 50% non-cannabis by volume (compostable or non-compostable mix); other methods need PRIOR LCB approval; records of method and final destination are kept 5 years (WAC 314-55-097(7)(e) points at WAC 314-55-087, whose period became five years under WSR 24-19-040, eff. 10/12/2024).",
