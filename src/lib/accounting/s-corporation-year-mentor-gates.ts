/**
 * src/lib/accounting/s-corporation-year-mentor-gates.ts   (books-44, slice C)
 *
 * THE COVERAGE GATES FOR THE S-CORPORATION-YEAR MENTOR
 *
 * ─────────────────────────────────────────────────────────────────────────────
 ...
 * (standing rule 39).
 *
 * The lesson data itself stays in `src/lib/accounting/s-corporation-year-mentor.ts`, which is now pure and
 * browser-safe.
 */
