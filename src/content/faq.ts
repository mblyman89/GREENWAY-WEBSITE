...
export const faqItems: readonly FaqItem[] = [
  {
    ...
    answer:
      "Greenway Marijuana is open from 8am – 11:00pm every day of the week, excluding Christmas Day.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Greenway Marijuana accepts cash only. We have an ATM in store and the fee is $2.50. Credit and debit cards are not currently accepted for cannabis purchases.",
  },
  {
    question:
      "What Are the Acceptable Forms of Identification at Greenway Marijuana?",
    answer:
      "• Driver’s License, Instruction Permit, or I.D. Card issued by any U.S. State, U.S. Territory, or District of Columbia.\n• Driver’s License, Instruction Permit, or I.D. Card issued by any Canadian Province.\n• Valid Washington State Temporary Driver’s License.\n• U.S. Armed Forces I.D. Card (Encrypted signature acceptable).\n• Merchant Marine I.D. Card issued by the U.S. Coast Guard.\n• Official Passport, Passport Card, Global Entry Card, Permanent Resident Card (commonly known as a “green card”), or NEXUS Card.\n• Washington State Tribal Enrollment Card (No expiration date required).",
  },
  {
    question:
      "Do I Have to Be a Washington State Resident to Purchase Cannabis?",
    answer:
      "You do not have to be a resident of Washington to purchase cannabis in Washington.",
  },
  {
