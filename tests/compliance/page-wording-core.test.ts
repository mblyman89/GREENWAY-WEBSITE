 ...
 *     then adds about at MS-2.1a, then locations at MS-2.1b,
 ...
 *   - exactly three pages are wired at MS-2.1b (a deliberate, per-slice snapshot).
 *
...
describe("page-wording-core", () => {
  ...
  it("has exactly three wording pages at MS-2.1b (snapshot)", () => {
    expect(PAGES_WITH_WORDING.size).toBe(3);
  });
